...
export function Pricing({ unlocked, onUnlock }: Props) {
  return (
    <section id="pricing" className="scroll-mt-24 px-4 py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mx-auto mt-3 max-w-xl text-center text-ink-soft">
          Built for a Sunday afternoon at the dining table — not a school-software contract.
        </p>
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          <article className="rounded-3xl border border-ink/10 bg-white p-6">
            ...
            <ul className="mt-4 space-y-2 text-sm text-ink-soft">
              ...
              <li>Name prints as “My Worksheet”</li>
            </ul>
          </article>
          <article className="relative rounded-3xl border-2 border-coral bg-white p-6 shadow-[0_16px_40px_-24px_#E06C5C]">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>Child’s name on every sheet</li>
              <li>No watermark</li>
            </ul>
            {unlocked ? (
          ...
          <article className="relative rounded-3xl border border-ink/10 bg-ink/[0.03] p-6 opacity-90">
            ...
            <p className="mt-2 font-display text-4xl">₹149</p>
            <ul className="mt-4 space-y-2 text-sm text-ink-soft">
              <li>Classroom bulk print</li>
              <li>Lists of up to 30 students</li>
              <li>Same lifetime perks</li>
              <li>Not in this prototype yet</li>
            </ul>
            <button
              type="button"
              disabled
              className="mt-5 w-full cursor-not-allowed rounded-xl bg-ink/10 py-3 text-sm font-bold text-ink/40"
            >
              Coming soon
            </button>
          </article>
